...
function peg$parse(input, options) {
  ...
  function peg$f3(right) {
    return -1.0 * right;
  }
  function peg$f4(fname, paramName, neg, paramValue, restParams) {
    let params = {};
  ...
  function peg$f6(integer, decimal) {
    if (decimal) {
